  ...
  return (
    <>
      <div className="relative">
        <div className="absolute inset-0 bg-cover bg-center bg-[url('/background.svg')] rotate-180"></div>
        <div className="relative z-10">
          <div className="flex flex-col pt-20 space-y-8">
            <div className="flex flex-col justify-center items-center">
              <p className="sm:text-3xl text-white  text-center font-medium md:text-4xl">
                Your AI Agent for
              </p>
              <p className="sm:text-3xl text-white text-center font-medium md:text-4xl">
